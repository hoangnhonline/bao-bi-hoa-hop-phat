						...
						<div class="contact-sidebar-item">
							...
							<div class="contact-sidebar-item-bottom">
								...
								<div class="contact-add">
									<a href="skype:2?chat"><img src="{{ URL::asset('public/assets/images/skype-icon.png') }}" alt=""></a>
									<a href="ymsgr:SendIM?baobitruongnx"><img src="{{ URL::asset('public/assets/images/Yahoo_3.png') }}" alt=""></a>
								</div>
							</div>
