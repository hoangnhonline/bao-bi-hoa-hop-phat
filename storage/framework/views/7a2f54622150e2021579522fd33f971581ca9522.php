				...
				<section class="block block-contact-sidebar block-title-sidebar">
					...
					<div class="block-content">
						<div class="contact-sidebar-item">
							<img src="<?php echo e(URL::asset('assets/images/contact2.jpg')); ?>" alt="">
							<div class="contact-sidebar-item-bottom">
								...
								<div class="contact-add">
									<a href="skype:2?chat"><img src="<?php echo e(URL::asset('assets/images/skype-icon.png')); ?>" alt=""></a>
									<a href="ymsgr:SendIM?baobitruongnx"><img src="<?php echo e(URL::asset('assets/images/Yahoo_3.png')); ?>" alt=""></a>
								</div>
							</div>
